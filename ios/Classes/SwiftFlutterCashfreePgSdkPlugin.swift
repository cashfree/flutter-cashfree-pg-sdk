    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        if method == "doUPIPayment" {
            do {
                ...
                upiPayment.setPlatform("iflt-e-2.0.16-3.3.10-m-s-x-i-\(systemVersion.prefix(4))")
            ...
            do {
                ...
                let cardPayment = try CFCardPayment.CFCardPaymentBuilder()
                    ...
                    .build()
                let systemVersion = UIDevice.current.systemVersion
                cardPayment.setPlatform("iflt-e-2.0.16-3.3.10-m-s-x-i-\(systemVersion.prefix(4))")
                if let vc = UIApplication.shared.delegate?.window??.rootViewController {
            ...
            do {
                ...
                let systemVersion = UIDevice.current.systemVersion
                dropCheckoutPayment.setPlatform("iflt-d-2.0.16-3.3.10-m-s-x-i-\(systemVersion.prefix(4))")
                if let vc = UIApplication.shared.delegate?.window??.rootViewController {
            ...
            do {
                ...
                let webCheckoutPayment = try CFWebCheckoutPayment.CFWebCheckoutPaymentBuilder()
                                ...
                                .build()
                let systemVersion = UIDevice.current.systemVersion
                webCheckoutPayment.setPlatform("iflt-c-2.0.16-3.3.10-m-s-x-i-\(systemVersion.prefix(4))")
                if let vc = UIApplication.shared.delegate?.window??.rootViewController {
