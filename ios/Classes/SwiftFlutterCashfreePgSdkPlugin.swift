    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        if method == "doNetbankingPayment" {
            do {
                ...
                netbankingPayment.setPlatform("iflt-e-2.2.6-3.13.3-m-s-x-i-\(systemVersion.prefix(4))")
            ...
            do {
                ...
                let upiPayment = try CFUPIPayment.CFUPIPaymentBuilder()
                    ...
                    .build()
                let systemVersion = UIDevice.current.systemVersion
                upiPayment.setPlatform("iflt-e-2.2.6-3.13.3-m-s-x-i-\(systemVersion.prefix(4))")
                if let vc = UIApplication.shared.delegate?.window??.rootViewController {
            ...
            do {
                ...
                if let paymentComponent = try self.createPaymentComponentsUpi() {
                    let dropCheckoutPayment = try CFDropCheckoutPayment.CFDropCheckoutPaymentBuilder()
                        ...
                        .build()
                    let systemVersion = UIDevice.current.systemVersion
                    dropCheckoutPayment.setPlatform("iflt-i-2.2.6-3.13.3-m-s-x-i-\(systemVersion.prefix(4))")
                    if let vc = UIApplication.shared.delegate?.window??.rootViewController {
            ...
            do {
                ...
                let cardPayment = try CFCardPayment.CFCardPaymentBuilder()
                    ...
                    .build()
                let systemVersion = UIDevice.current.systemVersion
                cardPayment.setPlatform("iflt-e-2.2.6-3.13.3-m-s-x-i-\(systemVersion.prefix(4))")
                if let vc = UIApplication.shared.delegate?.window??.rootViewController {
            ...
            do {
                ...
                let systemVersion = UIDevice.current.systemVersion
                dropCheckoutPayment.setPlatform("iflt-d-2.2.6-3.13.3-m-s-x-i-\(systemVersion.prefix(4))")
                if let vc = UIApplication.shared.delegate?.window??.rootViewController {
                    try self.cfPaymentGatewayService.doPayment(dropCheckoutPayment, viewController: vc)
                } else {
                    self.sendException(message: "unable to get an instance of rootViewController")
            ...
            do {
                ...
                let webCheckoutPayment = try CFWebCheckoutPayment.CFWebCheckoutPaymentBuilder()
                                ...
                                .build()
                let systemVersion = UIDevice.current.systemVersion
                webCheckoutPayment.setPlatform("iflt-c-2.2.6-3.13.3-m-s-x-i-\(systemVersion.prefix(4))")
                if let vc = UIApplication.shared.delegate?.window??.rootViewController {
